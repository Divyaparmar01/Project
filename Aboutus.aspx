...
<body>
    <form runat="server">
        <table width="100%" style="height:860px">
            ...
            <tr style="height:400px";"background-color:#BAF1E4">
                <td>
                    <table  width="100%" style="height:400px";>
                            <tr>
                                <td align="center" style="background-color:#BAF1E4">
                                    <asp:Label ID="Label4" runat="server" Text="Label" Font-Size="50px" Font-Italic="True" Font-Bold="True">About Us</asp:Label>
                                </td>
                            </tr>
                            <tr style="background-color:#BAF1E4">
                                <td>
                                    <table width="70%" style="height:150px" align="center">
                                        <tr>
                                            <td>
                                                <img src="Images\cakes.webp" alt="cakes" height="400" width="800" />
                                            </td>
                                         </tr>
                                    </table>
                                </td>
                              ...
                              <tr>
                                <td>
                                    <table style="background-color:#BAF1E4">
                                    <tr>
                                        <td style="text-align:center;" valign="top" width="60%">
                                            <p style="font-size:25px; font-family:Calibri">This is a place where you get a wide choice of rich delicious cakes for all the occasion. We sweet Delights, situated at Dondaicha, 
                                            Maharashtra, aim to serve the most creative and mouth watering cakes, to help celebrate your events in a special way! Pick a design 
                                            you like, and then choose from delectable flavours. You can then sit back and relax and expect a wonderful cake to arrive at your 
                                            desired location, on your chosen date and time.</p>
                                        </td>
                                    </tr>
                                    </table>
                                 </td>
